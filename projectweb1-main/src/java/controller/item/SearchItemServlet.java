...
public class SearchItemServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Item> items = ItemUserDao.searchItemsByName(keyword); // Truy vấn kết quả từ DB

        request.setAttribute("items", items); // Gửi kết quả qua trang home.jsp
