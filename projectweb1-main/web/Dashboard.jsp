...
<html>
    ...
    <body>
        ...
        <p>
            ...
            <a href="GetItemServlet_M">Quản lý sản phẩm</a><br/>
            <a href="manageOrders">Xem và Cập nhật đơn hàng</a><br/>
            <a href="reportPage">Xem báo cáo doanh thu</a><br/>
        </p>
        <h3>QUẢN LÝ SẢN PHẨM</h3>
        <a href="viewProducts">Xem sản phẩm</a><br/>
        <a href="addProduct">Thêm sản phẩm</a><br/>
        <a href="updateProduct">Cập nhật sản phẩm</a>
